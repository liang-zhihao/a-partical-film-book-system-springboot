...
//        TODO:Dont forget to write table
    ...
    public static JSONObject responseJson(int httpStatus, Object data, String msg) {
    ...
    public static boolean isDuplication(String key, Object val, IService service) throws ClassNotFoundException {

        QueryWrapper queryWrapper = new QueryWrapper<>();
        queryWrapper.eq(key, val);
        int res = service.count(queryWrapper);
        if (res != 0) {
            return true;
        } else {
            return false;
